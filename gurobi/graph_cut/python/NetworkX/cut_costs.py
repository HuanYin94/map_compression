...
file = open("/home/yinhuan/mapModel/yq/rows_cut/sparse/pose_graph_yq_sparse.txt")
...
saveFile = open("/home/yinhuan/mapModel/yq/rows_cut/sparse/cut_costs_yq_sparse.txt", 'w')
setA = []
