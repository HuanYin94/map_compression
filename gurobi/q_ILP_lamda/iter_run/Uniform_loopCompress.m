function [ epsilon_soft, time_sum  ] = Uniform_loopCompress( lamda, qFile, visFilesDir, splitLength, totalNum, bValue, saveDir )
...
%   Detailed explanation goes here
    ...
    for i=0:splitLength:length(files)-1
        ...
        % core
        [compressIndex, time_sec, epsilon_part] = section_compress(lamda, q_value, visFilesDir, start, finish, totalNum, bValue);
