function [ compressIndex, time, epsilon_soft ] = section_compress_Cells( lamda, q_value, visCells, start, finish, totalNum, bValue )
...
%   Detailed explanation goes here
    ...
    for i=start:1:finish
        pointID = visCells{i+1};  % read directly from the cells not the vis files from the beginning
                                                    % from one, not zero
