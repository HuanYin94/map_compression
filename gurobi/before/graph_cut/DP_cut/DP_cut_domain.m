% function [ DP_cost, DP_time, av_cost, av_time ] = DP_cut_domain( cutCostsFile, cut_num, search_domain )
function [ best_cuts ] = DP_cut_domain( cutCostsFile, cut_num, search_domain )
%DP_CUT_DOMAIN Summary of this function goes here
