...
subplot(1,4,3)
h = boxplot([trsError_ILP_1000, trsError_predict_1000, trsError_voxel_1000, trsError_random_1000, 999*ones(length(trsError_random_1000),1)], 'Labels',{'Mp','Ml','Mv','Mr', 'Ms'}, 'OutlierSize', 8);
title('b=1000');
ylim([0 0.5]);
ylabel('Translation error (m)', 'FontWeight', 'bold', 'FontSize', 12);
set(gca,'FontSize',12)
...
subplot(1,4,4)
h = boxplot([trsError_ILP_500, trsError_predict_500, trsError_voxel_500, trsError_random_500, 999*ones(length(trsError_random_1000),1)], 'Labels',{'Mp','Ml','Mv','Mr', 'Ms'}, 'OutlierSize', 8);
title('b=500');
ylim([0 0.5]);
ylabel('Translation error (m)', 'FontWeight', 'bold', 'FontSize', 12);
set(gca,'FontSize',12)
...
subplot(1,4,4)
h = boxplot([rotError_ILP_500, rotError_predict_500, rotError_voxel_500, rotError_random_500, 999*ones(length(rotError_random_1000),1)], 'Labels',{'Mp','Ml','Mv','Mr', 'Ms'}, 'OutlierSize', 8);
title('b=500');
ylim([0 1.0]);
ylabel('Rotation error (°)', 'FontWeight', 'bold', 'FontSize', 12);
set(gca,'FontSize',12)
