...
pose_kitti_b4000_ILP = pose_kitti_b4000_ILP(201:300,:);
pose_kitti_b4000_learn = pose_kitti_b4000_learn(201:300,:);
pose_kitti_b4000_voxel = pose_kitti_b4000_voxel(201:300,:);
pose_kitti_b4000_observe = pose_kitti_b4000_observe(201:300,:);
pose_kitti_b4000_random_1 = pose_kitti_b4000_random_1(201:300,:);
pose_kitti_b4000_random_2 = pose_kitti_b4000_random_2(201:300,:);
pose_kitti_b4000_random_3 = pose_kitti_b4000_random_3(201:300,:);
pose_kitti_b4000_random_4 = pose_kitti_b4000_random_4(201:300,:);
pose_kitti_b4000_random_5 = pose_kitti_b4000_random_5(201:300,:);



pose_kitti_b3000_ILP = pose_kitti_b3000_ILP(201:300,:);
pose_kitti_b3000_learn = pose_kitti_b3000_learn(201:300,:);
pose_kitti_b3000_voxel = pose_kitti_b3000_voxel(201:300,:);
pose_kitti_b3000_observe = pose_kitti_b3000_observe(201:300,:);
pose_kitti_b3000_random_1 = pose_kitti_b3000_random_1(201:300,:);
pose_kitti_b3000_random_2 = pose_kitti_b3000_random_2(201:300,:);
pose_kitti_b3000_random_3 = pose_kitti_b3000_random_3(201:300,:);
pose_kitti_b3000_random_4 = pose_kitti_b3000_random_4(201:300,:);
pose_kitti_b3000_random_5 = pose_kitti_b3000_random_5(201:300,:);



pose_kitti_b2000_ILP = pose_kitti_b2000_ILP(201:300,:);
pose_kitti_b2000_learn = pose_kitti_b2000_learn(201:300,:);
pose_kitti_b2000_observe = pose_kitti_b2000_observe(201:300,:);
pose_kitti_b2000_random_1 = pose_kitti_b2000_random_1(201:300,:);
pose_kitti_b2000_random_2 = pose_kitti_b2000_random_2(201:300,:);
pose_kitti_b2000_random_3 = pose_kitti_b2000_random_3(201:300,:);
pose_kitti_b2000_random_4 = pose_kitti_b2000_random_4(201:300,:);
pose_kitti_b2000_random_5 = pose_kitti_b2000_random_5(201:300,:);



pose_kitti_b1000_ILP = pose_kitti_b1000_ILP(201:300,:);
pose_kitti_b1000_learn = pose_kitti_b1000_learn(201:300,:);
...
for i =1:length(pose_kitti_b3000_learn)
    ...
    rotError_3000_observe(i,:) = getRotmError(pose_kitti_b3000_observe(i,:), kitti(i,:));
    trsError_3000_observe(i,:) = getTransError(pose_kitti_b3000_observe(i,:), kitti(i,:));
...
for i =1:length(pose_kitti_b2000_learn)
    ...
    rotError_2000_observe(i,:) = getRotmError(pose_kitti_b2000_observe(i,:), kitti(i,:));
    trsError_2000_observe(i,:) = getTransError(pose_kitti_b2000_observe(i,:), kitti(i,:));
...
figure
subplot(1,4,1)
h = boxplot([trsError_4000_ILP, trsError_4000_learn, trsError_4000_random, trsError_4000_voxel, 999*ones(100,1), trsError_4000_observe,  999*ones(100,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=4000');
ylim([0 0.5]);
...
subplot(1,4,2)
h = boxplot([trsError_3000_ILP, trsError_3000_learn, trsError_3000_random, trsError_3000_voxel, 999*ones(100,1),trsError_3000_observe,  999*ones(100,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=3000');
ylim([0 0.5]);
ylabel('Translation error (m)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
...
subplot(1,4,3)
h = boxplot([trsError_2000_ILP, trsError_2000_learn, trsError_2000_random, 999*ones(100,1), 999*ones(100,1), trsError_2000_observe,  999*ones(100,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=2000');
ylim([0 0.5]);
ylabel('Translation error (m)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
...
subplot(1,4,4)
h = boxplot([trsError_1000_ILP, trsError_1000_learn, 999*ones(100,1), 999*ones(100,1),  999*ones(100,1), 999*ones(100,1),  999*ones(100,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=1000');
ylim([0 1]);
ylabel('Translation error (m)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
...
figure
subplot(1,4,1)
h = boxplot([rotError_4000_ILP, rotError_4000_learn, rotError_4000_random, rotError_4000_voxel, 999*ones(100,1), rotError_4000_observe,  999*ones(100,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=4000');
ylim([0 1.0]);
...
subplot(1,4,2)
h = boxplot([rotError_3000_ILP, rotError_3000_learn, rotError_3000_random, rotError_3000_voxel, 999*ones(100,1),rotError_3000_observe,  999*ones(100,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=3000');
ylim([0 1.0]);
ylabel('Rotation error (°)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
...
subplot(1,4,3)
h = boxplot([rotError_2000_ILP, rotError_2000_learn, rotError_3000_random, 999*ones(100,1), 999*ones(100,1),rotError_2000_observe,  999*ones(100,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=2000');
ylim([0 1.0]);
ylabel('Rotation error (°)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
...
subplot(1,4,4)
h = boxplot([rotError_1000_ILP, rotError_1000_learn, 999*ones(100,1), 999*ones(100,1),  999*ones(100,1), 999*ones(100,1),  999*ones(100,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=1000');
ylim([0 1.0]);
ylabel('Rotation error (°)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
