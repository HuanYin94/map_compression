...
figure
subplot(1,4,1)
h = boxplot([trsError_4000_ILP, trsError_4000_learn, trsError_4000_random, trsError_4000_voxel, 999*ones(400,1), trsError_4000_random,  999*ones(400,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=4000');
ylim([0 0.5]);
...
subplot(1,4,2)
h = boxplot([trsError_3000_ILP, trsError_3000_learn, 999*ones(400,1), trsError_3000_voxel, 999*ones(400,1), 999*ones(400,1),  999*ones(400,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=3000');
ylim([0 0.5]);
ylabel('Translation error (m)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
...
subplot(1,4,3)
h = boxplot([trsError_2000_ILP, trsError_2000_learn, 999*ones(400,1), trsError_2000_voxel, 999*ones(400,1), 999*ones(400,1),  999*ones(400,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=2000');
ylim([0 0.5]);
ylabel('Translation error (m)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
...
subplot(1,4,4)
h = boxplot([trsError_1000_ILP, 999*ones(400,1), 999*ones(400,1), 999*ones(400,1),  999*ones(400,1), 999*ones(400,1),  999*ones(400,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=1000');
ylim([0 1]);
ylabel('Translation error (m)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
...
figure
subplot(1,4,1)
h = boxplot([rotError_4000_ILP, rotError_4000_learn, rotError_4000_random, rotError_4000_voxel, 999*ones(400,1), rotError_4000_observe,  999*ones(400,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=4000');
ylim([0 1.0]);
...
subplot(1,4,2)
h = boxplot([ rotError_3000_ILP, rotError_3000_learn,  999*ones(400,1), rotError_3000_voxel, 999*ones(400,1), 999*ones(400,1),  999*ones(400,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=3000');
ylim([0 1.0]);
ylabel('Rotation error (°)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
...
subplot(1,4,3)
h = boxplot([rotError_2000_ILP, rotError_2000_learn,  999*ones(400,1), rotError_2000_voxel, 999*ones(400,1), 999*ones(400,1),  999*ones(400,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=2000');
ylim([0 1.0]);
ylabel('Rotation error (°)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
...
subplot(1,4,4)
h = boxplot([rotError_1000_ILP,  999*ones(400,1),  999*ones(400,1), 999*ones(400,1), 999*ones(400,1), 999*ones(400,1),  999*ones(400,1)], 'Labels',{'Mp','Ml','Mr','Mv', 'Mc', 'Mt', 'Ms'}, 'OutlierSize', 8);
title('b=1000');
ylim([0 1.0]);
ylabel('Rotation error (°)', 'FontWeight', 'bold', 'FontSize', 30);
set(gca,'FontSize',18)  
