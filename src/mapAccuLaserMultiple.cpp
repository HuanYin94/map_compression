...
public:
    mapAccuLaserMultiple(ros::NodeHandle &n);
    ~mapAccuLaserMultiple();
    ros::NodeHandle& n;
...
mapAccuLaserMultiple::~mapAccuLaserMultiple()
{}

mapAccuLaserMultiple::mapAccuLaserMultiple(ros::NodeHandle& n):
    n(n),
...
void mapAccuLaserMultiple::process(int index)
{
    // loading velodyne
    stringstream ss;
    ...
    rangeFilter = getTravelledDis(lastPosition, currentPosition);
...
void mapAccuLaserMultiple::wait()
{
    ros::Rate r(1);
...
mapAccuLaserMultiple::DP mapAccuLaserMultiple::readBin(string filename)
{
    DP data;
...
double mapAccuLaserMultiple::getTravelledDis(Eigen::Vector3d inputA, Eigen::Vector3d inputB)
{
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "mapAccuLaserMultiple");
    ros::NodeHandle n;

    mapAccuLaserMultiple mapAccuLaserMultiple_(n);
